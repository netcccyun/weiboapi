  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">微博API管理中心</a>
      </div><!-- /.navbar-header -->
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="<?php echo checkIfActive(',index')?>">
            <a href="./"><span class="glyphicon glyphicon-home"></span> 后台首页</a>
		      ...
		      <li class="<?php echo checkIfActive('list,add')?>">
            <a href="./list.php"><span class="glyphicon glyphicon-list"></span> 账号列表</a>
          </li>
          <li class="<?php echo checkIfActive('log')?>">
            <a href="./log.php"><span class="glyphicon glyphicon-list-alt"></span> 操作日志</a>
          </li>
          <li class="<?php echo checkIfActive('imghost')?>">
            <a href="./imghost.php"><span class="glyphicon glyphicon-picture"></span> 微博图床</a>
          </li>
          <li>
            <a href="https://github.com/netcccyun/weiboapi/blob/main/admin/apidoc.md" target="_blank"><span class="glyphicon glyphicon-book"></span> 接口文档</a>
          </li>
